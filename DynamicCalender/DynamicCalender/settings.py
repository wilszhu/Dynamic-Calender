"""
Django settings for DynamicCalender project.
...
SECRET_KEY = 'django-insecure-aa494oudqcqg1194xo6a*m-ukb4k9@qhetg)&=hkzo6a3-bkwi'
...
ROOT_URLCONF = 'DynamicCalender.urls'
...
WSGI_APPLICATION = 'DynamicCalender.wsgi.application'
